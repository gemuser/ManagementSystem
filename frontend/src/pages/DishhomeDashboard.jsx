...
const DishhomeDashboard = () => {
  ...
  useEffect(() => {
    ...
    if (searchTerm.trim()) {
      filtered = filtered.filter(customer =>
        ...
        customer.casId.toLowerCase().includes(searchTerm.toLowerCase())
      );
    }
  ...
  const handleExport = () => {
    const csvContent = [
      ['Name', 'Phone', 'Package', 'Price', 'Address', 'CAS ID', 'Status', 'Month'],
    ...
    a.href = url;
    a.download = `dishhome_customers_${new Date().toISOString().split('T')[0]}.csv`;
    a.click();
  };
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">DishHome Dashboard</h1>
                  <p className="text-sm text-gray-600">Manage TV service customers</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 max-w-lg">
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Search customers by name, phone, address, package, or CAS ID..."
...
export default DishhomeDashboard;
